...
const FormInfoBox = (props) => {
  ...
  const [newUser, setnewUser] = useState({
    ...
    educazione:[{ titoloStudio: "Elemntarea", startTo: "1991" ,finishTo: "2022", luogo: "G.Marconi Afragola Napoli" , desc:"Scuola di materna di second grado obbligatoria"},
    { titoloStudio: "Licenza scuola Uperiore", startTo: "2021", finishTo: "2022" , luogo: "N.Stefanelli SessaArunca CE" , desc:"Scuola di terzo grado obbligatoria"}],
    premi:[{ titolo: "Elemntarea", data: "1991", luogo: "G.Marconi Afragola Napoli" , desc:"Scuola di materna di second grado obbligatoria"},
    { titolo: "Elemntarea", data: "1991", luogo: "G.Marconi Afragola Napoli" , desc:"Scuola di materna di second grado obbligatoria"},
   ],
  });
  ...
  return ( 
    <form  method="POST"  onSubmit={(e) => handleSubmit(e, newUser)} className="default-form">
      <div className="row">
     ...
     <Education setEducazioneToSend={setEducazioneToSend} educazioneList={newUser.educazione}></Education>
     <AwardsCertificates setPremiCertificatiToSend={setPremiCertificatiToSend} educazioneList={newUser.premi}></AwardsCertificates>
