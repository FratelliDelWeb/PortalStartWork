  ...
  return (
   ...
   { newUserSend !== "ok" ? (
    <div>
     ...
     {(newUserSend === "send") && ( newUserSend !== "ok") ? (<Loader></Loader>) :
     (
     <div class="row">
...
{errorSend ? (<div><h6>{errorSend}</h6></div>) :(<div></div>)}
</div>
             <div class="row mt-20">
                 ...
                 <div className="form-group">
                   ...
                   <input
                     ...
                     onChange={(e) =>
                       setnewUser(newUser => ({
                         ...newUser,
                         credentials: { ...newUser.credentials, email:  e.target.value }
                     }))
                     }
                   />
                 </div>
               ...
               <div className="form-group">
                 ...
                 <input
                   ...
                   onChange={(e) =>
                     setnewUser(newUser => ({
                       ...newUser,
                       credentials: { ...newUser.credentials, username:  e.target.value }
                   }))
                 }
                   required
                 />
               ...
               <div className="form-group">
                 ...
                 <input
                   ...
                   onChange={(e) =>
                     setnewUser(newUser => ({
                       ...newUser,
                       credentials: { ...newUser.credentials, password:  e.target.value }
                   }))
                   }
                   onBlur={(e) => validateInput(e)}
                 />
