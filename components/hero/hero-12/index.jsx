  ...
  return (
    <section className="banner-section-three -type-12 mt-30">
      <div className="bg-image">
        ...
        >
          {category === "Lavoro" ? (
            <img src="images/index-14/images/1.png" alt="index" />
          ) : (
            <img src="images/index-14/images/2.png" alt="index" />
          )}
        </figure>
      </div>
      {/* End bg-image */}
              ...
              <div className="row">
                <div className="content-column col-lg-6 col-md-12 col-sm-12">
                  <div className="title-box" data-aos="fade-up">
                    ...
                    {category === "Lavoro" ? (
                      <div className="text">
                        Trova lavoro e opportunità di carriera!
                      </div>
                    ) : (
                      <div className="text">
                ...
                <div className="content-column col-lg-6 col-md-12 col-sm-12">
                  <div className="title-box" data-aos="fade-up">
                    <div className="text">Cosa stai cercando ?</div>
                    {category === "Lavoro" ? (
                      <button
                        className="theme-btn -active mr-30"
                        onClick={() => setCategory("Lavoro")}
                        type="button"
                      >
                        <b>LAVORO </b>
                      </button>
                      ...
                      <button
                        className="theme-btn -white mr-30"
                        onClick={() => setCategory("Lavoro")}
                        type="button"
                      >
                        {" "}
